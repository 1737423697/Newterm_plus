    ...
    with open(rag_name, 'r', encoding='utf-8') as f, \
        ...
        for line in f:
            ...
            for p in range(3):
                ...
                elif 'term_rag' in prompt_type:
                    tmp = f"I've encountered the term \"{line['term']}\". Here's what I found related to this term: \"{line['term_rag']}\".\n"
                    tmp += f"Can you help me understand the meaning of \"{line['term']}\" based on this information? {system}\n\n"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prompt', type=str, choices=['BASE', 'GOLD', 'RAG', 'TERM_RAG'], default='BASE', help='Which prompt method to use.')
