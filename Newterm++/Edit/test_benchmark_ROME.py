...
for batch_size in batch_sizes:
    ...
    if args.model_type == 'qwen':
        hparams = ROMEHyperParams.from_hparams('Edit/EasyEdit/hparams/ROME/qwen-7b.yaml')
    elif args.model_type == 'llama':
        hparams = ROMEHyperParams.from_hparams('Edit/EasyEdit/hparams/ROME/llama-7b.yaml')
