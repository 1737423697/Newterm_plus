...
method = args.method
if method == 'ROME':
    results_dir = 'Edit/ROME/results'
    output_dir = 'Edit/ROME/results'
    os.makedirs(output_dir, exist_ok=True)
if method == 'MEMIT':
    results_dir = 'Edit/MEMIT/results'
...
if method == 'MEMIT':
    ...
    for model in [args.model_name]:
        output_file = f'Edit/ROME/results/{model}_generate_sim_{args.batch_size}.json'
        results_file = f'Edit/ROME/results/{model}_{args.batch_size}_generate.jsonl'
